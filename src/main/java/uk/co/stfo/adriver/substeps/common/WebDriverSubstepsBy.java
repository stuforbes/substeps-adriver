...
public abstract class WebDriverSubstepsBy {
    ...
    public static ByTagAndAttribute ByTagAndAttribute(final String tagName, final String attributeName,
    ...
    static class ByTagAndAttribute extends BaseBy {
        ...
        public ByTagAndAttribute(final String tagName, final String attributeName, final String attributeValue) {
            super();
        ...
        public String toString() {
            return "By.tag: " + tagName + " and attribute: " + attributeName + "=" + attributeValue;
        }
    }
    ...
    static class ByTagAndAttributes extends BaseBy {
        ...
        @Override
        public String toString() {
            return "By.tag: " + tagName + " and attributes: " + requiredAttributes;
        }
    }
    ...
    public static class ByText extends BaseBy {
        ...
        public List<WebElement> findElementsBy(final SearchContext context) {
            if (context instanceof WebElement) {
                final WebElement element = (WebElement) context;
    ...
    public static class ByTagAndWithText extends BaseBy {
        ...
        ByTagAndWithText(final String tag, final String text, final boolean matchPartial) {

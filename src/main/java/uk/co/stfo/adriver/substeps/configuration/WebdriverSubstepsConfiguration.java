...
import uk.co.stfo.adriver.substeps.driver.DefaultDriverType;
...
public enum WebdriverSubstepsConfiguration {
    ...
    private static final Class<? extends DriverFactory> WEBDRIVER_FACTORY_CLASS;
    ...
    static {
        ...
        try {
            WEBDRIVER_FACTORY_CLASS = Class.forName(Configuration.INSTANCE.getString("webdriver.factory.class")).asSubclass(DriverFactory.class);
    ...
    public static Class<? extends DriverFactory> getWebDriverFactoryClass() {
